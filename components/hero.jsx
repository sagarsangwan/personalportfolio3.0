    ...
    <div className='flex flex-wrap h-full '>
      <div className=' w-full h-min sm:w-1/2 my-10 md:my-auto flex justify-start'>
        <p className=' flex flex-col space-y-2'>
          <span className='text-3xl  md:text-6xl font-medium'>Hi, I'm </span>
      ...
      <div className=' w-full h-full sm:w-1/2 mx-auto my-auto flex justify-center '>
        <div className='relative h-52 w-60 md:h-96 md:w-full my-auto' >
